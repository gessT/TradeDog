...
from strategies.klse.data_loader import load_json
from strategies.klse.strategy import StrategyParams
from strategies.klse.backtest import run_backtest
from strategies.klse.optimizer import optimize, print_results, DEFAULT_GRID, QUICK_GRID
from strategies.klse.trade_log import print_trade_log, print_summary


def main():
    data_path = os.path.join(os.path.dirname(__file__), "..", "data", "vs_industry_stock.json")
