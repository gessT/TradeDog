"""
TPC Strategy — Indicators
==========================
Weekly:  SuperTrend
Daily:   EMA200, ADX, HalfTrend
1H:      EMA fast/slow, RSI, ATR, Volume MA
"""
...
def adx(high: pd.Series, low: pd.Series, close: pd.Series, period: int = 14) -> pd.Series:
    """Compute ADX (trend strength). Returns Series of ADX values."""
    ...
    plus_di = 100 * (plus_dm.ewm(alpha=1.0 / period, min_periods=period, adjust=False).mean() / atr_val.replace(0, 1e-10))
    minus_di = 100 * (minus_dm.ewm(alpha=1.0 / period, min_periods=period, adjust=False).mean() / atr_val.replace(0, 1e-10))
...
# ═══════════════════════════════════════════════════════════════════════
# HalfTrend  (faithful Pine Script port)
# ═══════════════════════════════════════════════════════════════════════
